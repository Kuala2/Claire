  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url("/assets/Blog1.png?v=2")',
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 w-full text-center py-20">
        ...
        <motion.div
            ...
            className="inline-flex flex-col sm:flex-row items-center gap-3 px-8 py-3 rounded-full bg-white border-2 border-primary/20 text-gray-900 mb-8 shadow-2xl"
        >
        ...
        <motion.h1 
            className="mx-auto max-w-5xl font-sans text-4xl font-extrabold tracking-tight text-white sm:text-6xl lg:text-7xl pb-2 leading-tight drop-shadow-[0_4px_15px_rgba(0,0,0,0.9)]"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <motion.p 
            className="mx-auto mt-8 text-xl sm:text-3xl leading-relaxed text-white max-w-3xl font-bold drop-shadow-[0_2px_10px_rgba(0,0,0,0.9)]"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
