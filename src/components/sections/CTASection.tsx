    ...
    <section id="booking" className="py-24 bg-white relative overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <motion.div
          ...
          viewport={{ once: true }}
          className="bg-primary/5 rounded-[3rem] p-12 sm:p-20 border border-primary/10 overflow-hidden relative"
        >
          {/* Decorative elements */}
          ...
          <div className="flex flex-col gap-8 justify-center items-center">
            <Button size="lg" className="h-16 px-12 text-lg rounded-full shadow-xl shadow-primary/20 hover:scale-105 active:scale-95 transition-all">
              Записаться онлайн
            </Button>
            
            <div className="flex items-center gap-6">
              <a href="#" className="w-14 h-14 flex items-center justify-center rounded-2xl bg-[#0077FF]/10 text-[#0077FF] hover:bg-[#0077FF] hover:text-white transition-all duration-300 shadow-sm border border-[#0077FF]/10" title="ВКонтакте">
            ...
            <a 
              ...
              className="text-xl font-bold text-gray-900 hover:text-primary transition-colors flex items-center gap-2 underline underline-offset-4 decoration-2 decoration-primary/30 hover:decoration-primary"
            >
              Или позвоните нам: {companyInfo.phone}
            </a>
          </div>
        </motion.div>
      </div>
